...
/*
This will help you handle your url loaders in the future.
Installation:  npm install url-loader --save-dev 

const fileLoaders = {
    test: /\.(png|jpe?g|gif|toff|svg|eot|woff|woff2)$/i,
        use: [
          {
            loader: 'url-loader',
            options: {
...
const styles = {
    ...
    use: ExtractTextPlugin.extract(["css-loader?url=false", postcss]),
};
